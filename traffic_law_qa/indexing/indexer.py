...
from .. import config
from ..contracts.disk import ChunkSet, IndexStats
from ..infra.embedding import EMBED_FAILED_NOTE_PREFIX, LocalEmbedder
from ..infra.milvus import MilvusStore, row_of
...
if __name__ == "__main__":
    raise SystemExit("已收口：请用 python -m traffic_law_qa.cli.build index（清单见 README「入口」）")
