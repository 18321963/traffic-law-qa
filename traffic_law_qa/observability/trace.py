...
from ..tools.render import LOG_MATERIAL, LOG_SEARCH, LOG_WEB
...
def render_trace(state: dict, *, color: bool = False) -> str:
    ...
    while cursor < len(messages):
        ...
        for call, reply in zip(calls, replies):
            ...
            elif text.startswith((LOG_WEB, LOG_MATERIAL)):
                lines.append(
